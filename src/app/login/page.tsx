...
localStorage.setItem("user", JSON.stringify(user));
      ...
      console.error("Data del back:", error.response?.data);
  ...
  return (
    <main className="min-h-screen bg-slate-950 grid lg:grid-cols-2">
      ...
      <section className="hidden lg:flex relative overflow-hidden flex-col justify-between p-10 border-r border-white/10 bg-gradient-to-br from-slate-950 via-emerald-950 to-slate-950">
        ...
        <div className="relative z-10 grid grid-cols-3 gap-4 mt-10">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-4">
            <Building2 className="text-emerald-400 mb-3" size={22} />
      ...
      {/* PANEL DERECHO */}
      <section className="flex items-center justify-center px-4 py-10 bg-slate-50">
        <div className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white">FEDEINVERSIONES</h1>
            <p className="text-slate-400 mt-2 text-sm">Plataforma Financiera</p>
          </div>

          <div className="hidden lg:block mb-8">
            <p className="text-slate-500 text-sm mb-2">Bienvenido nuevamente</p>
            <h2 className="text-3xl font-bold text-slate-700">Iniciar Sesión</h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                disabled={loading}
                className="w-full bg-slate-200 border border-slate-300 text-slate-700 px-4 py-3 rounded-xl outline-none focus:ring-2 focus:ring-emerald-500 transition disabled:opacity-60"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  disabled={loading}
                  className="w-full bg-slate-200 border border-slate-300 text-slate-700 px-4 py-3 rounded-xl outline-none focus:ring-2 focus:ring-emerald-500 transition pr-12 disabled:opacity-60"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <a href="#" className="text-emerald-600 hover:text-emerald-700 font-medium transition text-sm">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-emerald-600 hover:bg-emerald-700 transition py-3 rounded-xl text-white font-semibold shadow-lg shadow-emerald-900/30 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {loading ? (
          ...
          <div className="mt-8 border-t border-slate-200 pt-5 flex items-center justify-center gap-2 text-xs text-slate-400">
            <ShieldCheck size={14} />
