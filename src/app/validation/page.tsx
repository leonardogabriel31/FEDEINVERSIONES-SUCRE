          ...
          campos: [
            {
              icon: <Mail size={14} />,
              label: "Correo",
              value: val(selected.email),
            },
            {
              icon: <Hash size={14} />,
              label: "RIF",
              value: val(selected.rif),
            },
            {
              icon: <Users size={14} />,
              label: "N° Accionistas",
              value: val(selected.n_accionistas),
            },
            {
          ...
          campos: [
            {
              icon: <MapPin size={14} />,
              label: "Dirección",
              value: val(selected.address),
            },
            {
              icon: <MapPin size={14} />,
              label: "Municipio",
              value: val(selected.municipality),
            },
            {
              icon: <Hash size={14} />,
              label: "N° Casa",
              value: val(selected.home_number),
            },
            {
              icon: <Phone size={14} />,
              label: "Teléfono",
              value: val(selected.phone_number),
            },
          ],
        },
        {
          ...
          campos: [
            {
              ...
              value: val(selected.comercial_name),
            },
            {
              icon: <FileText size={14} />,
              label: "Objeto Social",
              value: val(selected.social_object),
            },
            {
              icon: <Briefcase size={14} />,
              label: "Productos",
              value: val(selected.products),
            },
            {
              icon: <CalendarDays size={14} />,
              label: "Constitución",
              value: val(selected.start_date),
            },
            {
              icon: <TrendingUp size={14} />,
              label: "Experiencia",
              value: val(selected.experience),
            },
            {
              icon: <Users size={14} />,
              label: "Trabajadores",
              value: val(selected.workers),
            },
            {
              icon: <CalendarDays size={14} />,
              label: "Hasta la fecha",
              value: val(selected.workers_to_date),
            },
            {
              icon: <DollarSign size={14} />,
              label: "Facturación último año",
              value: formatCurrency(selected.facturation_last_year),
            },
          ],
        },
        {
          ...
          campos: [
            {
              ...
              value: val(selected.mercantil),
            },
            {
              icon: <DollarSign size={14} />,
              label: "Capital Suscrito",
              value: val(selected.capital_suscribed),
            },
            {
              icon: <DollarSign size={14} />,
              label: "Capital Pagado",
              value: val(selected.capital_paid),
            },
            {
              icon: <Hash size={14} />,
              label: "Cédula Rep. Legal",
              value: val(selected.dni),
            },
            {
              icon: <Briefcase size={14} />,
              label: "Cargo",
              value: val(selected.company_position),
            },
          ],
        },
        {
          ...
          campos: [
            {
              icon: <Hash size={14} />,
              label: "N° Acciones",
              value: val(selected.n_actions),
            },
            {
              icon: <FileText size={14} />,
              label: "Tipo Acciones",
              value: val(selected.actions_type),
            },
            {
              icon: <DollarSign size={14} />,
              label: "Monto",
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 flex flex-col">
      ...
      <div className="flex-1 px-4 sm:px-8 py-8 sm:py-10 max-w-6xl mx-auto w-full">
        <div className="flex flex-wrap items-center gap-3 mb-6 sm:mb-8">
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-blue-600/20 border border-blue-500/20 flex items-center justify-center flex-shrink-0">
          ...
          {!loading && usuarios.length > 0 && (
            <span className="ml-auto flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs sm:text-sm font-medium">
              <Users size={13} />
              ...
              <tbody>
                {usuarios.map((u) => (
                  ...
                  >
                    ...
                    <td className="px-4 sm:px-6 py-4">
                      <span className="px-3 py-1 rounded-full text-xs font-medium bg-blue-500/10 border border-blue-500/20 text-blue-400 whitespace-nowrap">
                        {u.role}
                      </span>
                    </td>
                    ...
                    <td className="px-4 sm:px-6 py-4">
                      <button
                        ...
                        className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-xl bg-blue-600/20 border border-blue-500/30 text-blue-400 hover:bg-blue-600/30 transition text-xs sm:text-sm font-medium whitespace-nowrap disabled:opacity-50"
                      >
                        {loadingDetail ? (
        ...
        >
          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-blue-500/10 border border-blue-500/20 text-blue-400">
                      {selected.role}
                    </span>
            ...
            <div className="px-5 sm:px-6 pb-6 pt-4 border-t border-white/10 flex-shrink-0">
              {confirmed ? (
                <div className="flex items-center justify-center gap-3 py-3 rounded-xl bg-blue-500/15 border border-blue-500/30 text-blue-400 font-semibold text-sm">
                ...
                <button
                  ...
                  disabled={validating}
                  className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 transition text-white font-semibold text-sm shadow-lg disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {validating ? (
                    <>
